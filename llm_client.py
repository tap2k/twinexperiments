...
MODEL_MAP = [
    ...
    {'shortName': 'gpt-5.5', 'provider': 'openai', 'modelName': 'gpt-5.5', 'inputCost': 5.0, 'outputCost': 30.0, 'maxChars': 4200000},
    {'shortName': 'gpt-5.4', 'provider': 'openai', 'modelName': 'gpt-5.4', 'inputCost': 2.5, 'outputCost': 15.0, 'maxChars': 4200000},
    {'shortName': 'gpt-5.4-mini', 'provider': 'openai', 'modelName': 'gpt-5.4-mini', 'inputCost': 0.75, 'outputCost': 4.50, 'maxChars': 1600000},
    {'shortName': 'gpt-5.4-nano', 'provider': 'openai', 'modelName': 'gpt-5.4-nano', 'inputCost': 0.20, 'outputCost': 1.25, 'maxChars': 1600000},
    {'shortName': 'gpt-5.2', 'provider': 'openai', 'modelName': 'gpt-5.2', 'inputCost': 1.25, 'outputCost': 10.0, 'maxChars': 1600000, 'legacy': True},
    {'shortName': 'gpt-5-mini', 'provider': 'openai', 'modelName': 'gpt-5-mini', 'inputCost': 0.25, 'outputCost': 2.0, 'maxChars': 1600000, 'legacy': True},
    {'shortName': 'gpt-5-nano', 'provider': 'openai', 'modelName': 'gpt-5-nano', 'inputCost': 0.05, 'outputCost': 0.40, 'maxChars': 1600000, 'legacy': True},
